...
export function scorePackage(pkg, profile) {
  ...
  // generation doctrine.
  {
    const DISPARAGING = /\b(cesspool|dumpster fire|scammy|scam artists?|rip[- ]?offs?|sleazy|shady|sketchy|predatory|soulless|race to the bottom|churn and burn)\b/gi;
