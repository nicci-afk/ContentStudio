...
17. INDUSTRY RESPECT. The creator is a travel industry professional. Never write anything negative, critical, mocking, or cautionary about any supplier, resort, hotel, cruise line, airline, tour operator, venue, or destination, whether named or implied. No complaints, horror stories, warnings, or comparisons that place one below another. If source material contains a negative supplier or destination experience, omit it or recast it as a neutral, unnamed lesson that identifies no one. Every mention of a supplier or destination must be neutral or positive.`;
